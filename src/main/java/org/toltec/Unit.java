...
public class Unit extends GraphicObject {
    ...
    /** Change behavioural state. Restarts the new clip from frame 0. */
    ...
    /** Called once the unit reaches the end of its path. Default: switch to IDLE. Override to chain behaviour. */
    protected void onDestinationReached() { setStatus(UnitStatus.IDLE); }
    ...
    private void applyCurrentFrame() {
        ...
        // Config-driven overrides (see scale[...] / hitChance[...] / dodgeChance[...] /
        // blockChance[...] / attackInterruptChance[...] in UnitAnimationConfig) — each is only
        ...
        //
        // fitScale defaults to 1.0 (GraphicObject's own default) when nothing configures it;
        // the combat fields default to whatever the game set (or their own class defaults —
        // see their declarations above) when nothing configures them.
